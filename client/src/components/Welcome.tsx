...
const Welcome = () => {
  ...
  const handleSubmit = async (data: TransactionSend) => {
        ...
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          ...
          {!currentAccount && (
            <button
              ...
              className='flex flex-row justify-center items-center my-5 bg-dark-blue p-3 rounded-full hover:bg-hover-dark-blue'
            >
            ...
            <div className='flex justify-between flex-col w-full h-full'>
              ...
              <div>
                <p className='text-white font-light text-sm'>
                  {currentAccount ? shortenAddress(currentAccount) : 'Connect Account'}
                </p>
